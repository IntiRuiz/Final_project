...
const long double delta= T/240000;
...
void rk4(long double t, long double h, long double &x0, long double &x1, long double &y0, long double &y1)
{
  ...
  x0+=(1.0/6.0)*(k10+(2*k20)+(2*k30)+k40);
  x1+=(1.0/6.0)*(k11+(2*k21)+(2*k31)+k41);
  ...
  y0+=(1.0/6.0)*(p10+(2*p20)+(2*p30)+p40);
  y1+=(1.0/6.0)*(p11+(2*p21)+(2*p31)+p41);
}
